...
hoistedDependencies:
  ...
  anymatch@3.1.3:
    anymatch: private
  apps/gateway:
    '@concentrix/gateway': private
  apps/web:
    '@concentrix/web': private
  arg@5.0.2:
    arg: private
  array-flatten@1.1.1:
  ...
  packages/event-schemas:
    '@concentrix/event-schemas': private
  parseurl@1.3.3:
    parseurl: private
  ...
  ts-node-dev@2.0.0(@types/node@20.19.37)(typescript@5.9.3):
    ts-node-dev: private
...
pendingBuilds: []
prunedAt: Fri, 27 Mar 2026 16:45:50 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
virtualStoreDir: E:\Concentrix\concentrix-agentic-transformation-hub\node_modules\.pnpm
